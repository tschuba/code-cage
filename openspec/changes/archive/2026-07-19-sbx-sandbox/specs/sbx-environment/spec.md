...
The system SHALL use an sbx Kit (`spec.yaml`) as the single source of truth for sandbox configuration, covering `~/.claude/` access, credentials, and MCP server definitions.
